<%-- 
    Document   : slider
    Created on : Feb 25, 2019, 12:39:18 PM
    Author     : Admin
--%>
        ...
        <div class="owl-carousel owl-one owl-theme">
            <div class="item">
                <div class="slider-img">
                    <img src="/images/home/slide1.jpg" alt=""></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-6 col-xs-12">
                            <div class="slider-captions">
<!--                                <div class="brand-img">
                                    <img src="/images/home/slide1." alt="">
                                </div>-->
<!--                                <h1 class="slider-title">Red Mi <span>Y1</span></h1>
            ...
            <div class="item">
                <div class="slider-img"><img src="/images/home/slide2.jpg" alt=""></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-6 col-xs-12">
                            <div class="slider-captions">
...
<!--                                <h1 class="slider-title">Google Pixel 2</h1>
            ...
            <div class="item">
                <div class="slider-img"><img src="/images/home/slide3.jpg" alt=""></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 col-md-8 col-sm-6 col-xs-12">
                            <div class="slider-captions">
