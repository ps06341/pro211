                                ...
                                <c:forEach var="row" items="${orderlist}">
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary btn-sm hec-button">Edit</a></td>
                                            ...
                                            <c:otherwise>
                                                    <c:url var="edit" value="admin/editorder.htm">
                                                     <c:param name="id" value="${row.orders.orderId}"/>
                                                     <c:param name="cus" value="${row.orders.customer.username}"/>
                                                     <c:param name="od" value="${row.orders.orderDay}"/>
                                                     <c:param name="des" value="${row.orders.describe}"/>
                                                     <c:param name="sta" value="${row.orders.status}"/>
                                                </c:url>
