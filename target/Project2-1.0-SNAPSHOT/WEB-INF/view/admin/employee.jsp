                        ...
                        <form:form action="admin/employee.htm" method="POST" modelAttribute="emp" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <form:errors path="endDay" class="text-danger"/>
                                </div>
                                ...
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        ...
                                        <form:input path="account.username" value="${us}" class="form-control" placeholder="Account ID"/>
                                    </div>
                                    <form:errors path="account.username" class="text-danger"/>
                                </div>

                                <div class="summernote-clickable">
                                    <button name="addEmp" class="btn btn-primary btn-sm hec-button">Add
                                    </button>
                                    <button name="rsEmp" class="btn btn-primary btn-sm hec-button">Reset
                                    </button>
                                </div>
                            </div>
                        </form:form>
                            ...
                            <tbody>
                                <c:forEach var="row" items="${ep}">
                                    <tr>
                                        ...
                                        <td>${row.startDay}</td>
                                        <td>${row.endDay}</td>
                                        <td><img src="images/nhanvien/${row.image}"width="30" height="30"></td>
